  ...
  <div class="login-container">
    <div class="login-card">
      <div class="login-header">
        <h2><i class="fas fa-graduation-cap me-2"></i>Sign In</h2>
      ...
      <div class="login-body">
        ...
        <div class="mb-4">
          <label class="form-label small fw-bold text-dark">Captcha</label>
          <div class="d-flex align-items-center">
            <?php echo $captcha_image; ?>
            <input type="text" name="captcha" id="captcha" required class="form-control form-control-custom text-center ms-2"
