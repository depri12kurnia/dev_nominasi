...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btn_export_excel_utama', function() {
            ...
            // Build URL dengan parameter GET
            var url = "<?= site_url('admin/nominasi/export_excel_utama') ?>?prodi=" + encodeURIComponent(prodi) + "&kelas=" + encodeURIComponent(kelas);
            window.open(url, '_blank');
        });
        ...
        $(document).on('click', '#btn_export_excel_cadangan', function() {
            ...
            // Build URL dengan parameter GET
            var url = "<?= site_url('admin/nominasi/export_excel_cadangan') ?>?prodi=" + encodeURIComponent(prodi) + "&kelas=" + encodeURIComponent(kelas);
            window.open(url, '_blank');
        });
