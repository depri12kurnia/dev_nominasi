...
class M_nominasi extends CI_Model
{

    var $table = 'nominasi_camaba';
    // Sesuaikan variabel di Model/Controller agar match dengan array di atas:
    var $column_order = array(null, 'nomor_ujian', 'nama', 'nomor_pendaftaran', 'asal_sekolah', 'jurusan_sekolah', 'skor', 'status', 'pilihan_1', 'pilihan_2', 'kelas_pilihan_1', 'kelas_pilihan_2', 'jenis_kelulusan', null);
